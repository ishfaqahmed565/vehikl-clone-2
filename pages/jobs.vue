<template>
  <div>
    <BannerSec imgSrc="candid-2">
      <template #header>Jobs</template>
      <template #paragraph
        >Vehikl invests in our clients and our employees. If you are someone
        eager to learn, collaborate with others, and produce excellent results,
